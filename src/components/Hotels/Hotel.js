        ...
        <div className='row m-2 p-2' style={{ textAlign: "left" }}>
            ...
            <div className='col-2 p-2'>
                ...
                <br />
                {
                    props.hotel.room < 1
                        ?
                        <button className='btn btn-danger disabled' style={{fontWeight: 'bold'}}>Not Available</button>
                        :
                        props.auth.userId == null ?<div> <a href='login'><button className='btn btn-success'>Book Now</button></a></div>:
                        <button onClick={props.HotelSelect} className='btn btn-success' style={{fontWeight: 'bold'}}>Book Now</button>
                }
            </div>
        </div>
    );
