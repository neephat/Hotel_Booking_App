                ...
                <div>
                    <div className="container">
                        <ButtonGroup className='m-2' aria-label="Basic example">
                            ...
                            <Button onClick={(e) => { this.handleCategory(e, "all") }} className="catBtn mr-1">All</Button>
                            <Button onClick={(e) => { this.handleCategory(e, "Deluxe Single Room") }} className="catBtn mr-1">Deluxe Single Room</Button>
                            <Button onClick={(e) => { this.handleCategory(e, "Premier Single Room") }} className="catBtn mr-1">Premier Single Room</Button>
                            <Button onClick={(e) => { this.handleCategory(e, "Deluxe King Room") }} className="catBtn mr-1">Deluxe King Room</Button>
                            <Button onClick={(e) => { this.handleCategory(e, "Standard Signle Room") }} className="catBtn mr-1">Standard Signle Room</Button>
                            <Button onClick={(e) => { this.handleCategory(e, "Standard Double Room") }} className="catBtn mr-1">Standard Double Room</Button>
                        </ButtonGroup>
                        <div className="row">
                            ...
                            <Modal style={{ scrollable: "true" }} isOpen={this.state.modalOpen}>
                                ...
                                <ModalFooter>
                                    <Button className='btn btn-danger' style={{fontWeight: 'bold'}} onClick={this.toggleModal}>
                                        Close
                                    </Button>
                                </ModalFooter>
                            </Modal>
